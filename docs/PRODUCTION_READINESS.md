...
King's Press Editorial Desk is a local-first desktop product. Production
...
KINGS_PRESS_NATIVE_TARGET_ARCH=x64 \
KINGS_PRESS_NATIVE_DEPS_PATH=/tmp/kings-press-x64-deps \
KINGS_PRESS_NODE_RUNTIME_PATH=/tmp/kings-press-x64-node/bin/node \
KINGS_PRESS_NODE_RUNTIME_ARCH=x64 \
