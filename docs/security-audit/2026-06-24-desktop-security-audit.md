# Pillar Press Desktop Security Audit - 2026-06-24
...
- Tauri native shell <-> webview JavaScript through the bundled `window.PILLAR_DESKTOP` bridge and custom IPC commands.
