# King's Press UX Readiness Audit - 2026-06-24
...
- Ran `npm run desktop:verify-installed`: pass. The verifier mounted the 0.1.1 DMG, copied the app payload, launched the copied installed app, completed conversational onboarding, reached the setup handoff, and confirmed the installed app served from `http://127.0.0.1:55768`.
...
- Long Ollama pull: "This can take several minutes for large models. Keep King's Press open while Ollama downloads it."
- Startup failure screen: "King's Press could not start its local server. Open the data folder for logs, then relaunch or reinstall the app."
