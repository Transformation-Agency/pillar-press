# King's Press Production Readiness Audit
...
Audit and harden King's Press Editorial Desk as a local-first Tauri desktop app
...
| `npm run desktop:build` | Pass | Built `.app` and `King's Press Editorial Desk_0.1.1_aarch64.dmg` |
...
```text
src-tauri/target/release/bundle/dmg/King's Press Editorial Desk_0.1.1_aarch64.dmg
