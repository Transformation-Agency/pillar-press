...
const env: NodeJS.ProcessEnv = {
  ...
  PILLAR_PRESS_STORAGE: process.env.PILLAR_PRESS_STORAGE === "local" ? "supabase" : (process.env.PILLAR_PRESS_STORAGE || "supabase"),
  PILLAR_PRESS_DB_PATH: "",
  PILLAR_PRESS_DATA_DIR: "",
  PILLAR_PRESS_STORAGE_DIR: "",
